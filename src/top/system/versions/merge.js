...
export const mergeVersions = (versions, previousVersions) =>
  mapValues({ ...versions, ...previousVersions }, (_, propName) =>
    mergeVersionsValue(
      versions[propName],
...
const mergeVersionsValue = (values, previousValue, propName) => {
...
const mergeValues = (values, previousValue) => {
